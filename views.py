...
from constances import MAIN_MENU, MAIN_MENU_ACTION, SUB_MENU, SUB_MENU_ACTION, MENU_REPORT, MENU_REPORT_ACTION, \
    MESSAGE_INVALID
...
class DisplayTournamentView:
    ...
    def fill_information_tournament(self) -> dict:
        ...
        date_tournament = ValidateInputView.is_valid_date("Date du tournoi (jj/mm/aaaa)")
        time_control = ValidateInputView.is_time_control_right("Cadence (coup rapide)")
        number_round_tournament = ValidateInputView.is_input_digit("Nombre de round du tournoi [4]")
...
class DisplayPlayerView:
    ...
    def fill_information_player(player_number: int) -> dict:
        ...
        birth_date_player = ValidateInputView.is_valid_date("Date de naissance du joueur (jj/mm/aaaa)")
    ...
    def display_player_created_message(players: list):
        ...
        for player in players:
            print(f"{player.last_name} {player.first_name}, rank: {player.rank}, score: {player.score}")
...
class DisplayReportView:
    ...
    def display_all_rounds(self, tournament, tournament_round: list):
        """
